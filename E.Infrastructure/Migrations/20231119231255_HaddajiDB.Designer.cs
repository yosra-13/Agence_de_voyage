...
namespace E.Infrastructure.Migrations
{
    ...
    [Migration("20231119231255_HaddajiDB")]
    partial class HaddajiDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivitePack", b =>
                {
                    b.Property<int>("ActivitesActivateId")
                        .HasColumnType("int");

                    b.Property<int>("PacksPackId")
                        .HasColumnType("int");

                    b.HasKey("ActivitesActivateId", "PacksPackId");
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Activite", b =>
                {
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Conseiller", b =>
                {
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Pack", b =>
                {
            ...
            modelBuilder.Entity("ActivitePack", b =>
                {
                    b.HasOne("E.ApplicationCore.Domain.Activite", null)
                        .WithMany()
                        .HasForeignKey("ActivitesActivateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E.ApplicationCore.Domain.Pack", null)
                        .WithMany()
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Activite", b =>
                {
                    b.OwnsOne("E.ApplicationCore.Domain.Zone", "Zone", b1 =>
                        {
                            b1.Property<int>("ActiviteActivateId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("ActiviteActivateId");

                            b1.ToTable("Activites");

                            b1.WithOwner()
                                .HasForeignKey("ActiviteActivateId");
                        });
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Client", b =>
                {
                    b.HasOne("E.ApplicationCore.Domain.Conseiller", "Conseiller")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("E.ApplicationCore.Domain.Reservation", b =>
                {
                    ...
                    b.HasOne("E.ApplicationCore.Domain.Pack", "Pack")
                        .WithMany("Reservations")
