    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activites", x => x.ActivateId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActivitesActivateId = table.Column<int>(type: "int", nullable: false),
                    PacksPackId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitePack", x => new { x.ActivitesActivateId, x.PacksPackId });
                    table.ForeignKey(
                        name: "FK_ActivitePack_Activites_ActivitesActivateId",
                        column: x => x.ActivitesActivateId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NbPersonnes = table.Column<int>(type: "int", maxLength: 4, nullable: false)
                },
                constraints: table =>
                {
